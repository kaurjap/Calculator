...
// SOLUTION  Dr. Hill, I resolved this design error by creating a wrapper facade
...
// removed those methods from here and included their implementation in the
// facade class.
...
// Since, It was a partially abstract class, and not a pure abstract class, it could've been
// instantiated. Hence, I created an instance of that to keep track of the precedence and managed
